...
2. Go inside express-cr-hw folder
...
10. In todo router:
    ...
    d. Make a GET "/get-todo-by-id" route that takes in a params and responds with the id, todo and done. If ID is not found respond with the message "The Todo ID you are looking for does not exists, please check ID"
